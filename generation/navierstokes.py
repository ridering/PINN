...
@squeeze_result
def navier_stokes_2d(batch_size=20, visc=1e-3, s=256, num_steps=100, T=50.0, seed=42, device='cpu', **kwargs):
    """
...
class NavierStokesDataset(Dataset):
    def __init__(
        ...
        w0, w, f = navier_stokes_2d(num_samples, visc, x_steps, t_steps, t_max, seed=seed, device=device)

        self._config['initial_conditions'] = w0
        self._config['data'] = w
        self._config['f'] = f
